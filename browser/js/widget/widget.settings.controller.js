app.controller('WidgetSettingsCtrl', function($scope, $timeout, $rootScope, $uibModalInstance, $uibModalStack, widget, WidgetFactory, ChartService, dataset, element, graphSize) {
    $scope.widget = widget;
    $scope.chartType;

...
app.controller('DashboardCtrl', function (currentDataset, currentDashboard, loggedInUser, $scope, $timeout, $uibModal, GraphService, DatasetFactory, DashboardFactory, WidgetFactory, $stateParams, $rootScope, ChartService){
